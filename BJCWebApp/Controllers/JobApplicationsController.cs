...
namespace BJCWebApp.Controllers
{
    public class JobApplicationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,JobID,ClientID,IsInterested,DateApplied,HasCV,CVID,FreeText")] JobApplication jobApplication)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,JobID,ClientID,IsInterested,DateApplied,HasCV,CVID,FreeText")] JobApplication jobApplication)
        {
