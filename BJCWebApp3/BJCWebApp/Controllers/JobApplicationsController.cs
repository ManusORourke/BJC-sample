...
namespace BJCWebApp.Controllers
{
    ...
    public class JobApplicationsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            else
            {
                ...
                var applications = await _context.JobApplication
                    .Include(s => s.Job)
                    .Include(s => s.UserProfile)
                    .Where(a => a.UserProfileID == userProfile.ID).ToListAsync();
        ...
        public async Task<IActionResult> Create([Bind("ID,JobID,UserProfileID,IsInterested,DateApplied,HasCV,CVFileID,FreeText")] JobApplication jobApplication)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,JobID,UserProfileID,IsInterested,DateApplied,HasCV,CVFileID,FreeText")] JobApplication jobApplication)
        {
